...
function evolve(population::Population,genN,mutateR,maxYears,oneOverP,groupSize,trialC,filename)
    ...
    fitValue=mostFits[end]

    open(filename, "a") do file
       println(file,"$(groupSize) $(trialC) $(oneOverP) $(fitValue)")
    end
...
begin
	...
	fitValue=evolve(population,genN,mutateR,maxYears,oneOverP,groupSize,trialC,filename)
